...
var latitude    = "28.545153"; // Use this website to find your coordinates: http://itouchmap.com/latlong.html
var longitude   = "-81.37599";
var address     = "150 E. Robinson St. #801, <br />Orlando, FL 32801";
var phone       = "407-334-6559";
var email       = "chris@webeffectual.com";
...
$("#contact-form").submit(function(event) {
  ...
  var posting = $.post( url, { name: $('.name').val(), email: $('.email').val(), budget: $('.budget').val(), message: $('.message').val() } );
